...
export const metadata = {
  title: "關於與版權聲明 | Plurk CSS Editor",
};
  ...
  return (
    <main className="min-h-screen bg-[#f7f7fb] text-[#222]">
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <h1 className="mb-2 text-3xl font-bold">關於 Plurk CSS Editor</h1>
        <p className="mb-8 text-sm text-[#666]">最後更新：2026 年 4 月</p>
        ...
        <section className="mb-8 space-y-3 rounded-xl border border-[#ececf3] bg-white p-6 shadow-sm">
          ...
          <p className="leading-relaxed text-[#444]">
            本工具協助使用者在 Plurk 上編寫與預覽自訂 CSS。介面中的河道、貼文、儀表板等區塊
            僅為<strong>樣式編輯用的模擬預覽</strong>，方便對照 selector 與視覺效果。
          </p>
        </section>
        ...
        <section className="mb-8 space-y-3 rounded-xl border border-[#ececf3] bg-white p-6 shadow-sm">
          ...
          <ul className="list-disc space-y-2 pl-5 leading-relaxed text-[#444]">
            ...
            <li>「Plurk」為 Plurk, Inc. 之商標；本工具僅供使用者個人樣式編輯參考。</li>
        ...
        <section className="mb-8 space-y-3 rounded-xl border border-[#ececf3] bg-white p-6 shadow-sm">
          ...
          <ul className="list-disc space-y-2 pl-5 leading-relaxed text-[#444]">
            ...
            <li>本工具目前以非營利、個人／社群用途為主；公開功能與授權條款可能隨開發調整。</li>
          </ul>
        </section>
